...
class GradientDetection:
    ...
    #<---Butonların Oluşturulması--->
        ...
        imageButton=Button(self.root,image=fotoImage,bd=0,highlightthickness=0,command=laplaceDetect,bg="#03994c",fg="#ffffff")
        imageButton.image=fotoImage
        imageButton.place(x=120,y=575)

        videoButton=Button(self.root,image=videoImage,bd=0,highlightthickness=0,command=sobelXDetect,bg="#03994c",fg="#000000")
        videoButton.image=videoImage
        videoButton.place(x=220,y=575)

        streamButton=Button(self.root,image=camImage,bd=0,highlightthickness=0,command=sobelYDetect,bg="#03994c",fg="#ffffff")
    ...
    #<---Labelların Oluşturulması--->
        ...
        title=Label(self.root,text="Görüntü Değişimi ",font = "Arial 12 bold ",bg="#03994c",fg="#000000")
