...
class ImagePyramid:
    ...
    #<---Butonların Oluşturulması--->
        ...
        filebulButton=Button(self.root,image=find,bd=0,highlightthickness=0,command=openFileImg2,width=24,height=24,bg="#03994c",fg="#000000")
    ...
    #<---Labelların Oluşturulması--->
        ...
        title=Label(self.root,text="Görüntü Piramitleri ",font = "Arial 12 bold ",bg="#03994c",fg="#000000")
        ...
        fileLocName=Label(self.root,text="2. Dosya Yolu :",font = "Arial 10 ",bg="#03994c",fg="#000000")
        fileLocName.place(x=55,y=135)
        
        fileLoc=Label(self.root,text="Lütfen Bir Dosya Seçin ...",font = "Arial 10 ",bg="#03994c",fg="#000000")
        fileLoc.place(x=160,y=135)
        
        myImage=Label(self.root,image=noImage,bg="#03994c",fg="#ffffff",width=450,height=250)
        myImage.place(x=50,y=170)

        myImage2=Label(self.root,image=noImage,bg="#03994c",fg="#ffffff",width=450,height=250)
        myImage2.place(x=50,y=430)

        myImage3=Label(self.root,image=noImage,bg="#03994c",fg="#ffffff",width=450,height=470)
