...
class ImageSmoothing:
    def __init__(self,master):
        ...
        def openFileImg():
            try:
                filename=filedialog.askopenfilename(initialdir="/img/", title="Lütfen bir Resim veya Video Dosyası Seçin",filetypes=(("JPG File", "*.jpg"),("PNG File", "*.png"),("MP4 File", "*.mp4"),("AVI File", "*.avi")))
    ...
    #<---Butonların Oluşturulması--->
        ...
        bulButton=Button(self.root,image=find,bd=0,highlightthickness=0,command=openFileImg,width=24,height=24,bg="#03994c",fg="#000000")
        bulButton.image=find
        bulButton.place(x=980,y=100)

        imageButton=Button(self.root,image=smooth,bd=0,highlightthickness=0,command=imgDetect,bg="#03994c",fg="#ffffff")
        imageButton.image=smooth
        imageButton.place(x=120,y=575)

        videoButton=Button(self.root,image=gaussian,bd=0,highlightthickness=0,command=imgGaussianDetect,bg="#03994c",fg="#000000")
        videoButton.image=gaussian
        videoButton.place(x=220,y=575)

        streamButton=Button(self.root,image=median,bd=0,highlightthickness=0,command=imgMedianDetect,bg="#03994c",fg="#ffffff")
    ...
    #<---Labelların Oluşturulması--->
        ...
        title=Label(self.root,text="Görüntü BulanıkLaştırma (Görüntü Yumuşatma)",font = "Arial 12 bold ",bg="#03994c",fg="#000000")
        ...
        myImage=Label(self.root,image=noImage,bg="#03994c",fg="#ffffff",width=450,height=400)
        myImage.place(x=50,y=145)

        myImage2=Label(self.root,image=noImage,bg="#03994c",fg="#ffffff",width=450,height=400)
