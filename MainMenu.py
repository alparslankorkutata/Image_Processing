...
class MainMenu:
    def __init__(self):
        ...
        self.window.configure(background='#03556b')
        ...
        hello =Label (self.window,text=" Hoşgeldiniz ",bg="#03556b",fg="#ffffff")
        hello.place(x=1110,y=300)

        msg =Label (self.window,text="\n Bu programı kullanarak \n görüntü işleme örneklerinin nasıl çalıştığını görebilirsiniz.  ",bg="#03556b",fg="#ffffff")
        msg.place(x=1000,y=330)

        copyright =Label (self.window,text=" Copyright (c) 2022 Ferhat KORKUTATA ",bg="#03556b",fg="#ffffff")
