...
class ObjectDetection:
    ...
    #<---Butonların Oluşturulması--->
        ...
        videoButton=Button(self.root,image=videoImage,bd=0,highlightthickness=0,command=self.objVideo,bg="#03994c",fg="#000000")
        videoButton.image=videoImage
        videoButton.place(x=220,y=575)

        streamButton=Button(self.root,image=camImage,bd=0,highlightthickness=0,command=self.objWeb,bg="#03994c",fg="#ffffff")
    ...
    #<---Labelların Oluşturulması--->
        ...
        title=Label(self.root,text="Nesne Algılama",font = "Arial 12 bold ",bg="#03994c",fg="#000000")
