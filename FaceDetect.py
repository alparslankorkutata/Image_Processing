...
class FaceDetection:
    ...
    #<---Butonların Oluşturulması--->
        ...
        videoButton=Button(self.root,image=videoImage,bd=0,highlightthickness=0,command=self.faceVideo,bg="#03994c",fg="#000000")
        videoButton.image=videoImage
        videoButton.place(x=220,y=575)

        streamButton=Button(self.root,image=camImage,bd=0,highlightthickness=0,command=self.faceWeb,bg="#03994c",fg="#ffffff")
    ...
    #<---Labelların Oluşturulması--->
        ...
        title=Label(self.root,text="Yüz tanıma ",font = "Arial 12 bold ",bg="#03994c",fg="#000000")
        ...
        myImage2=Label(self.root,image=noImage,bg="#03994c",fg="#000000",width=450,height=400)
